...
class ApplicationWindow(QtWidgets.QMainWindow):
    ...
    def addEntry(self, toBeUpdated):
        ...
        self.currentEntriesFilter = {'M10': {'key': '2', 'entries': self.M10Entries},
                                     'M14': {'key': '1', 'entries': self.M14Entries},
                                     'G10': {'key': '4', 'entries': self.G10Entries},
                                     'G14': {'key': '3', 'entries': self.G14Entries}}
    ...
    def addPlotG10(self, g10):
        ...
        if (g10[0]):
            ...
            g10_tempa = self.g10_w1.plot(self.g10_tempa_x, self.g10_tempa_y, pen=(191, 0, 0),
    ...
    def sensorEntryListICCB(self, item):
        ...
        if (slave == "1"):
            ...
            if (
                    sensor == "17" or sensor == "18" or sensor == "19" or sensor == "33" or sensor == "34" or sensor == "35"):
